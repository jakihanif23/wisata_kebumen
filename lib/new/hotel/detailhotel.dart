  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (BuildContext context,
          ...
          final kom = hotelRef.doc(wis).collection('Komentar');
          return Scaffold(
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) {
                                                  return MapSample(
                                                    index: hotelDoc['lat'],
                                                    index1: hotelDoc['lang'],
                                                    index2: hotelDoc['nama'],);
                                                }));
                                      },
                                      child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      StreamBuilder<QuerySnapshot>(
                                        stream: hotelRef.doc(wis).collection('Komentar').snapshots(),
                                        builder: (_,snapshot) {
                                          if (!snapshot.hasData) {
                                            return Center(
                                              child: CircularProgressIndicator(),
