...
class DetailHotel extends StatefulWidget {
  DetailHotel({required this.index});
  final String index;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (BuildContext context,
          ...
          final kom = hotelRef.doc(widget.index).collection('Komentar');
          return Scaffold(
                              ...
                              child: InkWell(
                                onTap: (){
                                  Navigator.of(context).push(
                                      MaterialPageRoute(builder: (context)=>MapSample(index: hotelDoc['lat'], index1: hotelDoc['lang'], index2: hotelDoc['nama']))
                                  );
                                },
                                child: Padding(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Text(
                                        '\b\b\b\b\b\b${hotelDoc['description']}',
                                ...
                                Container(
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                          ...
                                          children: [
                                            TextSpan(
                                                text: 'Untuk Harga Perkamarnya Dimulai Dari \n\n'
                                            ),
                                            TextSpan(
                                              text: 'Rp. ${hotelDoc['harga']}'
                                            )
                                          ]
                                      ),
                                    )
